...
/* specify the parser */
  final public 
void Start(PrintStream printStream) throws ParseException, NumberFormatException {int value;
    label_1:
    while (true) {
...
{if ("" != null) return value ;}
  ...
  final public int Num() throws ParseException, NumberFormatException {Token t ;
        int value ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUMBER:{
...
{if ("" != null) return value ;}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1224,0x1224,0x30,0x30,0xc0,0xc0,0x100,0x224,};
   }
