...
/* Factor: consists of a real number and an int power */
  final public double Factor() throws ParseException, NumberFormatException {double power ;
        double value ;
    value = RealNum();
    label_4:
    while (true) {
...
{if ("" != null) return value ;}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4224,0x4224,0x30,0x30,0xc0,0xc0,0x100,0x820,0x224,};
   }
